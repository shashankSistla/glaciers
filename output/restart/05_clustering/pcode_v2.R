...
glacier <- 'G077314E43095N'
costs = readRDS(paste0("output/restart/04_candidate_paths/output/", glacier,"_path_costs.rds"))
costs
...
for(glacier in glacier_list){
  ...
  for(path in selected_paths){
    ...
    plot_name =  paste0(glacier,"_",path,"_original vs fit.png")
    ...
    saveRDS(list(R_squared = R_squared, params_estimated = params_estimated, results = results), paste0(glacier,"_",path,"_results.rds"))
    plot_name =  paste0(glacier,"_",path,"_simulated.png")
    png(plot_name)
    ...
    plot_name =  paste0(glacier,"_",path,"_residuals.png")
    png(plot_name)
    # Plot the residuals
